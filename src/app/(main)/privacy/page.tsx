...
// Components
import PrivacyModalLink from "@/components/main/privacy/PrivacyModalLink";

export default function PrivacyPage() {
	return (
		<main>
			<section className="top-0 left-0 overflow-x-hidden lg:py-40 py-20">
				<article className="fade-in min-h-screen flex flex-col lg:w-[75dvw] w-[90dvw] mx-auto">
					<div className="">
						<div className="lg:flex justify-center lg:px-20">
							<h2 className="lg:text-6xl text-5xl font-bold text-center mt-10 mb-5 lg:mt-0">
