							...
							<ProjectFadeIn index={3}>
								<div className="grid lg:grid-cols-2 grid-cols-1 justify-evenly my-6 gap-4">
									{project.outLink && project.outLinkText && (
										<Link
											target="_blank"
											className="lg:w-full rounded-xl py-2 text-center transition-all font-bold text-xl bg-white border-2 border-black hover:bg-green-500 hover:border-white hover:text-white"
