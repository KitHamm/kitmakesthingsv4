	...
	return (
		<>
			<div
				...
				} transition-all fixed top-0 left-0 w-auto lg:w-1/6 h-screen bg-neutral-100 border-e-2 z-40`}
			>
				...
				<div
					...
					} flex flex-col my-8 transition-all lg:opacity-100`}
				>
					<NavLink
						link="/dashboard"
						text="Statistics"
			...
			<div className="lg:hidden fixed bottom-3 left-3 z-40 bg-neutral-300 p-3 rounded-full border-2 shadow">
